        ...
        if (args.length == 1) {
            ...
            switch (args[1].toLowerCase()) {
                ...
                default:
                    ...
                    player.sendMessage(ChatColor.RED + "Available towers: tnt, slowness, hunger, wither, arrow, haste, regeneration, speed, friendly, enemy");
            }

        } else {
            player.sendMessage(ChatColor.RED + "Usage: /tower shop");
        }
