...
public class RegenerationTower {
    ...
    public void Tower(Location l) {
        ...
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX() - 1, l.getBlockY(), l.getBlockZ()).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY(), l.getBlockZ() + 1).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY(), l.getBlockZ() - 1).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);

        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX() + 1, l.getBlockY() + 4, l.getBlockZ()).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX() - 1, l.getBlockY() + 4, l.getBlockZ()).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY() + 4, l.getBlockZ() + 1).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY() + 4, l.getBlockZ() - 1).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY() + 4, l.getBlockZ()).setTypeIdAndData(Material.RED_SANDSTONE.getId(), (byte) 0, true);
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX(), l.getBlockY() + i, l.getBlockZ() - 1).setTypeIdAndData(Material.STAINED_GLASS.getId(), (byte) 1, true);
            Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX() + 1, l.getBlockY() + i, l.getBlockZ()).setTypeIdAndData(Material.STAINED_GLASS.getId(), (byte) 1, true);
            Bukkit.getWorld(l.getWorld().getName()).getBlockAt(l.getBlockX() - 1, l.getBlockY() + i, l.getBlockZ()).setTypeIdAndData(Material.STAINED_GLASS.getId(), (byte) 1, true);
        }
