...
public class PastebinImpl implements Pastebin {
  ...
  public PastebinImpl( final String devKey) {
    this.devKey = devKey;
  }


  @Override
  public Response<String> post( final Paste paste) {
    return post(paste, null);
  }


  @Override
  public Response<String> post( final Paste paste, final String userKey) {
  ...
  @Override
  public Response<String> login( final String userName,  final String password) {
  ...
  @Override
  public Response<User> getUser( final String userKey) {
  ...
  @Override
  public Response<List<Paste>> getPastesOf( final String userKey) {
    return getPastesOf(userKey, DEFAULT_NUMBER_OF_PASTES);
  }


  @Override
  public Response<List<Paste>> getPastesOf( final String userKey, final int limit) {
  ...
  @Override
  public Response<Boolean> deletePaste( final String pasteKey,  final String userKey) {
