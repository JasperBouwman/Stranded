...
public class HttpEndpointConnection<T> {
  ...
  public HttpEndpointConnection<T> addParameter( final String key,  final String value) {
    parameters.put(key, value);
    return this;
  }

  public HttpEndpointConnection<T> removeParameter( final String key) {
  ...
  private String buildResponse( final InputStream source) throws IOException {
